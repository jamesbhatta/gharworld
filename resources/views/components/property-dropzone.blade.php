<div>
    <div class="white p-3">
        <form id="myAwesomeDropzone" action="{{ route('property-images.store') }}" method="post" class="dropzone" enctype="form-data/multipart">
            @csrf
            <div class="fallback">
    ...
    <script>
        ...
        $(function() {
            ...
            var deleteUrl = "{{ route('property-images.destroy', 'IMAGE_ID ') }}";
            ...
            function loadImages() {
                $.ajax("{{ route('property-images.index', $property->id) }}", {
                    dataType: 'json'
