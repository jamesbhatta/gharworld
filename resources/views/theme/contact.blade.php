...
<section class="contact-section spad">
    <div class="container">
        <h4 class="py-4 text-center">Get In Touch</h4>
        <div class="row">
            <div class="col-md-4 text-center my-5 py-3">
                ...
                <h4>
                    ...
                    <div class="py-2 fa fa-phone text-center"><a href="tel:{{$profile->contact}}" class="text-dark">
                            {{$profile->contact}} </a> <span class="py-2 fa fa-whatsapp text-center"> <a href="tel:{{$profile->whatsapp}}" class="text-dark">
                                {{$profile->whatsapp}}</a> </span> </div>
                    ...
                    <div class="py-2 text-info">
                        ...
                        <span class="py-2 "><a href="{{$profile->youtube}}"><i class="fa fa-twitter btn btn-primary"></i></a> </span>
                        <span class="py-2 "><a href="{{$profile->youtube}}"><i class="fa fa-instagram btn btn-danger"></i></a> </span>
                    </div>
                </h4>
                @endisset
            </div>
