                    ...
                    <div class=" si-v-2">
                        <div class="row pl-3">
                            <select type="text" name="city_id" id="city_id"
                                class="col-md-7 form-control js-example-theme-single @error('city_id') is-invalid @enderror">
                            ...
                            <select id="select-professions" name="profession_id"
                                class="col-md-3 form-group form-control " style="display: none;">
