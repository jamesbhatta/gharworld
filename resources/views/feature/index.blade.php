        ...
        <div class="row">
            ...
            <div class="col-md-4 mx-auto">
                <div class="card z-depth-0 sticky-top">
                    <div class="card-body">
                        <form action="{{ $feature->id ? route('features.update', $feature) : route('features.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control"
                                    value="{{ old('name', $feature->name) }}" placeholder="Enter feature name">
                            </div>
                            <div class="form-group">
                                <label for="" class="required">Feature Icon</label>
                                <input type="text" name="icon" class="form-control"
                                    value="{{ old('icon', $feature->icon) }}" placeholder="Enter icon (fa fa-icon)">
                            </div>
                            <div class="form-group">
                            ...
                            <tbody>
                                @forelse($features as $feature)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('features.edit', $feature) }}" class="text-muted"><i
                                                    class="fa fa-edit"></i></a>
                                            <span class="mx-3">|</span>
                                            <form action="{{ route('features.destroy', $feature) }}"
